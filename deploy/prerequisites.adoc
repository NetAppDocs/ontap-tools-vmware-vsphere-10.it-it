...
== Limiti di configurazione per il rilevamento del backend di archiviazione

ONTAP tools supporta il rilevamento del backend di storage per un massimo di 200 SVM e circa 10.000 LUN.
