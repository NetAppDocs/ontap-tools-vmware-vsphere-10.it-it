...
. Aggiungere i datastore alla protezione del cluster host seguendo link:../manage/edit-hostcluster-protection.html["Modificare il cluster host protetto"]. Aggiungere sia i tipi di policy asincroni che sincroni.
