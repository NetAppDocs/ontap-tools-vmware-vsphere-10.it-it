...
summary: Configura SRA con la procedura guidata VMware Live Site Recovery Array Manager per connettere i siti protetti e di recovery alle macchine virtuali di storage. 
---
