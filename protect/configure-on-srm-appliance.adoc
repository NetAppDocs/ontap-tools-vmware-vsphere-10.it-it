...
summary: 'Configura SRA sull"appliance VMware Live Site Recovery per abilitare i flussi di lavoro di disaster recovery con ONTAP tools.' 
---
...
* Abilitare i servizi SRA in ONTAP tools Manager. Per ulteriori informazioni, consultare la link:../manage/enable-services.html["Abilita i servizi"] sezione.
* Aggiungi i server vCenter all'appliance ONTAP tools for VMware vSphere. Per ulteriori informazioni, consulta la sezione link:../configure/add-vcenter.html["Aggiungi server vCenter"].
* Aggiungere backend di storage a ONTAP tools for VMware vSphere. Per ulteriori informazioni, consultare la sezione link:../configure/add-storage-backend.html["Aggiungere backend di archiviazione"].



NOTE: Se è stata applicata la patch del certificato vCenter dagli strumenti ONTAP , aggiornare la configurazione vCenter nell'appliance VMware Live Site Recovery utilizzando la porta (:5480).  Per le istruzioni, fare riferimento a https://techdocs.broadcom.com/us/en/vmware-cis/live-recovery/site-recovery-manager/8-8/site-recovery-manager-installation-and-configuration-8-8/reconfiguring-the-site-recovery-manager-virtual-appliance/reconfigure-the-site-recovery-manager-appliance.html["Riconfigurare l'appliance Site Recovery Manager"] .
