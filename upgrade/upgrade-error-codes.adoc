...
summary: Utilizza i codici di errore di aggiornamento di ONTAP tools per identificare i flussi di lavoro non riusciti e risolvere i problemi di aggiornamento in VMware vSphere. 
---
...
| 068 | Il ripristino dei pacchetti del sistema operativo Debian non è riuscito | Utilizza un ripristino basato su RPO pari a zero o su snapshot e riprova l'aggiornamento. 
...
| 074 | Montaggio ISO non riuscito | Controlla il file /var/log/otvng/upgrade-run.log e riprova l'upgrade. 
...
| 084 | La modifica di JobManager in produzione non è riuscita | Esegui i seguenti passaggi per ripristinare/completare l'aggiornamento. 1. Abilita la Diagnostic Shell 2. Esegui il comando: _sudo perl /home/maint/scripts/post-deploy-upgrade.pl --postupgrade_ 3. Controlla i log in /var/log/otvng/post-deploy-upgrade.log 


| 087 | Procedura di post-aggiornamento non riuscita. | Esegui i seguenti passaggi per ripristinare/completare l'aggiornamento. 1. Abilita la Diagnostic Shell 2. Esegui il comando _sudo perl /home/maint/scripts/post-deploy-upgrade.pl --postupgrade_ 3. Controlla i log in /var/log/otvng/post-deploy-upgrade.log 
...
| 098 | Copiare il secret dockercred dal namespace ntv-system al namespace rook-ceph non è riuscito | Controllare i registri di aggiornamento e riprovare l'aggiornamento. 
...
| 090 | convalida del certificato per i backend di archiviazione e vCenter non riuscita | Controlla i log di aggiornamento e il file di log in /var/log/otvng/cert_validation_error.log e riprova l'upgrade. 
