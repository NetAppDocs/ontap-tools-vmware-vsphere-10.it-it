...
A partire da ONTAP tools for VMware vSphere 10.4, ONTAP tools crea e gestisce automaticamente oggetti ONTAP e vCenter, semplificando la gestione dei datastore negli ambienti datacenter VMware.
...
NOTE: È possibile riutilizzare solo gli igroup personalizzati. Gli igroup creati durante la migrazione da ONTAP tools 9.x (igroup migrati) non possono essere riutilizzati e, a partire da ONTAP tools 10.5P2, vengono eliminati automaticamente quando non sono più in uso.
