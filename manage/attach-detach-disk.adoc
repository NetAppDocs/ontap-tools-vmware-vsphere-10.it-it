...
summary: Collega o scollega i dischi dati delle macchine virtuali per gestire la capacità di storage. 
---
...
. Selezionare il disco che si desidera collegare e fare clic sul pulsante *OK*.
