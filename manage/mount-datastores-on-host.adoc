...
* Quando un datastore con nconnect viene montato su un nuovo host, ONTAP tools applica il valore nconnect del datastore se questo supera l'impostazione dell'host.
