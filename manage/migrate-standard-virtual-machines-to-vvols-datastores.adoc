...
. Seleziona un formato di disco virtuale, una policy storage delle macchine virtuali e un datastore vVol corrispondente alle funzionalità del datastore da migrare, quindi fai clic su *Avanti*.
