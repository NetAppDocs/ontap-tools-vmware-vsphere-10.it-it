...
. Come esempio di una singola chiamata API, scorrere verso il basso fino alla categoria *vCenters* e fare clic su *GET* accanto all'endpoint `/virtualization/api/v1/vcenters`
