...
summary: Consulta la dashboard di ONTAP tools per vedere un riepilogo dello stato dei plug-in, dei datastore e dei dati del server vCenter. 
---
...
Se aggiungi un nuovo host a un cluster host protetto, le impostazioni di protezione cambiano in *Parzialmente protetto*.

Per risolvere questo problema, apri *Modifica configurazione cluster*, assegna l'host al sito corretto (origine o destinazione) e seleziona *Modifica*.
