...
. Dopo una registrazione e un aggiornamento della pagina corretti, vengono visualizzati lo stato, il nome e la versione del provider VASA registrato. Dopo la registrazione, viene attivata l'azione di annullamento della registrazione.
