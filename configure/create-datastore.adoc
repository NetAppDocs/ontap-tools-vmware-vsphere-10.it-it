...
. Seleziona una VM di archiviazione nel riquadro *Archiviazione*. Fornisci il *Nome del gruppo iniziatore personalizzato* nella sezione *Opzioni avanzate* come richiesto. Puoi scegliere un igroup esistente per il datastore oppure crearne uno nuovo con un nome personalizzato.
+
