...
Per ulteriori informazioni, vedere https://library.netapp.com/ecm/ecm_download_file/ECMLP3327064["Note sulla versione dei tool ONTAP per VMware vSphere 10,2"^].
