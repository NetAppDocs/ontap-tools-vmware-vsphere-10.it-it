...
Per ulteriori informazioni, consultare https://library.netapp.com/ecm/ecm_download_file/ECMLP3319071["Note sulla versione dei tool ONTAP per VMware vSphere 10,1"^].
